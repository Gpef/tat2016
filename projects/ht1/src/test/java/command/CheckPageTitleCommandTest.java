 ...
 * @since 21.11.2016
 */
public class CheckPageTitleCommandTest {
    ...
    public void setUp() throws Exception {
        ...
        properties.put(PROPERTY_TITLE, TEST_TITLE);
        propertiesStrings = new String[]{COMMAND_NAME, TEST_TITLE};
        command = new CheckPageTitleCommand.Builder().build(properties);
    }

    @Test
    public void testGetProperty() throws Exception {
        softAssert.assertEquals(command.getProperty(PROPERTY_COMMAND), COMMAND_NAME);
        softAssert.assertEquals(command.getProperty(PROPERTY_TITLE), TEST_TITLE);
    }
    ...
    @Test(dataProvider = "truePropertiesCheckPageTitle", dataProviderClass = CommandBuildDataProviders.class)
    public void testBuilderCanBuildTrue(HashMap<String, String> properties) throws Exception {
        assertTrue(new CheckPageTitleCommand.Builder().canBuild(properties));
    }

    @Test(dataProvider = "falsePropertiesCheckPageTitle", dataProviderClass = CommandBuildDataProviders.class)
    public void testBuilderCanBuildFalse(HashMap<String, String> properties) throws Exception {
        assertFalse(new CheckPageTitleCommand.Builder().canBuild(properties));
    }

    @Test(dataProvider = "truePropertiesCheckPageTitle", dataProviderClass = CommandBuildDataProviders.class)
    public void testBuilderBuild(HashMap<String, String> properties) throws Exception {
        new CheckPageTitleCommand.Builder().build(properties);
    }
